...
class _CalendarState extends State<Calendar> {
  ...
  late List<NeatCleanCalendarEvent> _selectedEvents;
  ...
  Widget get nameAndIconRow {
    ...
    if (!widget.hideArrows) {
      leftArrow = GestureDetector(
        onTap: isExpanded ? previousMonth : previousWeek,
        child: Container(
            padding: const EdgeInsets.only(right: 5),
            color: Colors.transparent,
            child: const Icon(Icons.chevron_left, color: neutralBlack)),
      );

      rightArrow = GestureDetector(
        onTap: isExpanded ? nextMonth : nextWeek,
        child: Container(
            padding: const EdgeInsets.only(left: 5),
            color: Colors.transparent,
            child: const Icon(Icons.chevron_right, color: neutralBlack)),
      );
    } else {
      leftArrow = Container();
    ...
    if (widget.datePickerType != DatePickerType.hidden) {
    ...
    return Container(
      padding: const EdgeInsets.only(left: 16, top: 16, right: 15),
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Row(
              ...
              children: <Widget>[
                displayMonth.txt16(color: const Color(0xFF222222), fontW: F.w5),
                jumpDateIcon,
              ],
            ),
          ),
    ...
    return Container(
      ...
      decoration: ShapeDecoration(
        ...
        shape: RoundedRectangleBorder(
          // side: const BorderSide(width: 0.97, color: Color(0xFFEAECF0)),
